...
// ***Using  Full Serializer***
public class FileDataHandler
{
    private string dataDirPath = "";
    private string dataFileName = "";
    private bool useEncryption = false;
    private readonly string encryptionCodeWord = "wordEncryption";
    private readonly string backupExtension = ".bak";
    private bool _assertSuccessDebug;

    private static readonly fsSerializer _serializer = new fsSerializer();

    public FileDataHandler(string dataDirPath, string dataFileName, bool useEncryption, bool assertSuccessDebug)
    {
        this.dataDirPath = dataDirPath;
        this.dataFileName = dataFileName;
        this.useEncryption = useEncryption;
        _assertSuccessDebug = assertSuccessDebug;
    }
    ...
    public GameData Load(string profileId, bool allowRestoreFromBackup = true)
    {
        ...
        if (File.Exists(fullPath))
        {
            try
            {
                ...
                loadedData = (GameData)Deserialize(typeof(GameData), dataToLoad);
            }
            catch (Exception e)
            {
    ...
    public void Save(GameData data, string profileId)
    {
        ...
        try
        {
            ...
            string dataToStore = Serialize(typeof(GameData), data);
    ...
    private object Deserialize(Type type, string serializedState)
    {
